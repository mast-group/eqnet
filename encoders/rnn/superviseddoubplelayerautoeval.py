...
def run_from_config(params, *args):
    ...
    local_params["hidden_layer_size"] = 2 ** local_params["log_hidden_layer_size"]
    del local_params["log_hidden_layer_size"]

    encoder = RecursiveNNSupervisedEncoder(train_file, local_params, combination_type='double')
